...
{
   char *first_arg = "pngtest.png";
   char *second_arg = "rez.png`";
   ...
   if (png_image_begin_read_from_file(&image, first_arg) != 0)
   {
      png_bytep buffer;
               ...
               0/*row_stride*/, NULL/*colormap*/) != 0)
      {
         ...
         if (png_image_write_to_file(&image, second_arg, 0/*convert_to_8bit*/,
